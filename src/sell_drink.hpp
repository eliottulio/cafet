...
class Sell_drink : public Gtk::Frame {
public:
	Sell_drink(Window& window);
	virtual ~Sell_drink();
...
protected:
	...
	void on_size_button_clicked(const Drink_size& drink_size);
	void on_size_cancel_button_clicked();
